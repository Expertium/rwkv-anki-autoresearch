...
| A18 | 0.2993ᵛ | 0.2684ᵛ | rejected | 557,246 | −251,516 | +0.000108 / +0.000111 | 0 | invented | **A17's width + LoRA 8→4 = 4.95× below 2.76M.** Both modes ~110% of bar — SECOND draw at d=80 ⇒ genuine FLOOR, not noise. LoRA halving is no longer free at this width (was positive at d=128). ≥5× and the ratio gate now conflict — Andrew's call (cumulative vs A0 only +0.00096/+0.00053). |
