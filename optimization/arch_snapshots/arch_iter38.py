...
_layers = [
    ...
    (
        ...
        RWKV7Config(
            d_model=32 * N_HEADS,
            n_heads=N_HEADS,
            n_layers=5,  # iter38: deck 4->5 (CHEAP stream) compensates note 3->2; param-neutral swap
            layer_offset=0,
            total_layers=5,
            channel_mixer_factor=1.0,
            decay_lora=16,
    ...
    (
        ...
        RWKV7Config(
            d_model=32 * N_HEADS,
            n_heads=N_HEADS,
            n_layers=2,  # iter38: note 3->2 (EXPENSIVE deploy, many notes) -> 12.75->8.5 KiB/note
            layer_offset=0,
            total_layers=2,
            channel_mixer_factor=1.0,
            decay_lora=16,
