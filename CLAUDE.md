...
⚠ **It is not cheap: a capacity change alters the architecture, so it cannot branch off ws10's WS checkpoint and needs its own ~38 h WS.** That is why it is a proposal for Andrew and not a queued branch. The cheap half of the question -- does the ahead gap track capacity at all -- is what Q2 already answered.
