...
REM This waits on CELL B's terminal marker. Cell B is parked behind the sweep, which is parked
REM behind the eval, so the chain stays serial. Anchored findstr -- the unanchored form matches
...
set LOG=C:\Users\Andrew\rwkv-anki-autoresearch\scratchpad\features_ab\wait_e2s_v2.log
set PREVLOG=C:\Users\Andrew\rwkv-anki-autoresearch\scratchpad\features_ab\featA2_on_e2s\featA2xe2s.log
...
echo cell B finished, GPU free %DATE% %TIME% >> "%LOG%"
