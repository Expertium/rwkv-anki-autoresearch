...
REM V2 (2026-09-09 23:42): arm 1's ORIGINAL runner wrote DONE_EXIT_28 into w10plain.log --
REM a false failure, its decay finished and only its artifact guard looked in the wrong
REM directory. That log now carries a terminal marker, so this waiter polls the EVAL-only
REM rerun's fresh log instead. A waiter must never poll a log that already has a marker.
setlocal
cd /d C:\Users\Andrew\rwkv-anki-autoresearch
set LOG=C:\Users\Andrew\rwkv-anki-autoresearch\scratchpad\w10qat\wait_qat2.log
set G0=C:\Users\Andrew\rwkv-anki-autoresearch\scratchpad\w10plain\w10plain_eval.log
echo ===== arm-2 waiter v2 armed %DATE% %TIME% ===== >> "%LOG%"
:waitarm1
if not exist "%G0%" (
