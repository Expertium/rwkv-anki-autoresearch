...
REM   1. the GPU is free -- the gen4base EVAL RESUME (queued behind the ablation) has reported
REM      (v2, 2026-09-03: the eval OOM'd at 1700/2500; the resume must finish BEFORE realcyc, because
REM      realcyc's control is gen4base and two GPU jobs deadlock this card);
...
set GPULOG=C:\Users\Andrew\rwkv-anki-autoresearch\scratchpad\gen4_base\wait_evalresume.log
set DBLOG=C:\Users\Andrew\rwkv-anki-autoresearch\scratchpad\features_rebuild\rebuild5.log

echo ===== realcyc waiter v2 armed %DATE% %TIME% ===== >> "%LOG%"
