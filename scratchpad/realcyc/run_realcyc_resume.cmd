...
REM RESUMED from the newest rc_ws checkpoint after the gen-5 train db moved to the SSD.
...
.venv\Scripts\python.exe -u -m rwkv.train_rwkv --config scratchpad/realcyc/ws_resume.toml > "%DIR%\ws_%STAMP%.log" 2>&1
if not %ERRORLEVEL%==0 (
