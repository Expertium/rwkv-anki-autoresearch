@echo off
REM lorawd -- generated by scratchpad/lorawd/mk_lorawd.py from the realcyc runner. DO NOT HAND-EDIT.
REM ======================================================================================
...
.venv\Scripts\python.exe scratchpad/write_decay_setup.py scratchpad/lorawd lwd_ws lwd_d %DIR%\decay.toml F:/rwkv_lmdb/train_db_5k_h1_id5 1 5000 1.0 1e-3 65536 > "%DIR%\dsetup_%STAMP%.log" 2>&1
if not %ERRORLEVEL%==0 (
