...
set DIR=C:\Users\Andrew\rwkv-anki-autoresearch\scratchpad\parity_gen5
...
set RWKV_REF_DIR=reference_realcyc
...
echo ===== gen-5 parity export START %DATE% %TIME% ===== > "%LOG%"
...
if not exist "reference_realcyc\ref_metrics.json" (
